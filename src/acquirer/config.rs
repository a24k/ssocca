...
mod tests {
    ...
    #[rstest]
    #[case(args!["--url", "https://example.com/", "sample.toml"])]
    #[case(args!["--headless", "--url", "https://example.com/", "sample.toml"])]
    #[case(args!["--chrome", "/path/to/chrome", "--url", "https://example.com/", "sample.toml"])]
    #[case(args!["--timeout", "5", "--url", "https://example.com/", "sample.toml"])]
